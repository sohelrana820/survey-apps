...
class InitialMigration extends AbstractMigration
{
    ...
    public function change()
    {
        ...
        $productTable = $this->table('products')
            ...
            ->addColumn('meta_title', 'string', ['default' => true, 'null' => true])
            ->addColumn('meta_description', 'string', ['default' => true, 'null' => true])
            ->addColumn('meta_image', 'string', ['default' => true, 'null' => true])
        ...
        $downloadLinksTable = $this->table('download_links')
            ...
            ->addColumn('downloaded_at', 'datetime', ['default' => null, 'null' => true])
